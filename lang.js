...
const t = {
  ...
  // Hero
  'hero.badge':{en:'Your AI Voice Alchemist',fr:'Votre assistant vocal de poche',de:'Ihr Taschen-Sprachassistent',es:'Tu asistente de voz de bolsillo',it:'Il tuo assistente vocale tascabile',zh:'你的口袋语音助手'},
  ...
  // How It Works
  'how.tag':{en:'Simple & Fast',fr:'Comment ça marche',de:'So funktioniert\'s',es:'Cómo funciona',it:'Come funziona',zh:'使用流程'},
  ...
  // Smart Styles
  'styles.tag':{en:'AI Smart Styles',fr:'Styles intelligents',de:'Intelligente Stile',es:'Estilos inteligentes',it:'Stili intelligenti',zh:'智能风格'},
  ...
  // Who It's For
  'who.tag':{en:'Built for Thinkers',fr:'Pour qui',de:'Für wen',es:'Para quién',it:'Per chi',zh:'适合谁用'},
